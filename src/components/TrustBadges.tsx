const badges = [
  {
    ...
    description: "We work directly with every club",
    icon: (
  ...
  },
  {
    ...
    description: "WhatsApp response within minutes",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: "500+ Tables Booked",
    description: "Trusted by London nightlife regulars",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
