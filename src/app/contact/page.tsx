    ...
    <>
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <WhatsAppCTA className="text-lg py-4 px-10" />
          ...
          <div className="mt-16 text-left space-y-8">
            ...
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-8 h-8 rounded-full bg-gold/20 text-gold font-bold flex items-center justify-center text-sm">
                1
              </div>
              <div>
                <h3 className="font-semibold mb-1">You send us your details</h3>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold mb-1">We check availability</h3>
                <p className="text-text-muted text-sm leading-relaxed">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold mb-1">We confirm your booking</h3>
                <p className="text-text-muted text-sm leading-relaxed">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold mb-1">You turn up and enjoy</h3>
                <p className="text-text-muted text-sm leading-relaxed">
          ...
          <div className="mt-12 p-6 bg-bg-card border border-border rounded-xl text-left">
            <h3 className="font-semibold mb-3">Not sure which club to pick?</h3>
